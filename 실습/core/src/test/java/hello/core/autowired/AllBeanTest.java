...
public class AllBeanTest {
    ...
    @Test
    void findAllBean() {
        // 스프링 컨테이너를 생성하면서, 해당 컨테이너에 동시에 AutoAppConfig, DiscountService를 빈으로 자동 등록함
    ...
    static class DiscountService {
        // DiscountService는 Map으로 만든 DiscountPolicy를 주입받음 (fixDiscountPolicy, rateDiscountPolicy)
